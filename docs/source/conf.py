...
# -*- coding: utf-8 -*-
#
# bearychat.py documentation build configuration file, created by
...
project = 'bearychat.py'
copyright = '2016, Beary Innovative'
author = 'Beary Innovative'
...
latex_documents = [
    (master_doc, 'bearychatpy.tex', 'bearychat.py Documentation',
